...
let showChartAnime = () => {
  setTimeout(() => {
    ...
    circle.setAttribute("style", "width:700px; height:850px; border-radius:12px; margin: 0px auto;justify-content: flex-start;");
  }, 200);
  setTimeout(() => {
...
let siteNames = ["Vibe", "Youtube Music", "Spotify", "Melon", "Genie", "Bugs", "Flo", "Apple Music"];
let siteNums = 0;
...
reset.addEventListener("click", () => {
  musicBox.setAttribute("style", "opacity:1;");
  circle.setAttribute("style", "width: 80%; height:800px; margin:0 auto; border-radius: 12px;");
